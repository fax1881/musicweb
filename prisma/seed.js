...
const artists = [
  {
    ...
    socials: { spotify: 'https://open.spotify.com/artist/6AcHcYKBjvIpGKWFsfErtD' },
  },
  {
    name: 'Hakan Güray',
    slug: 'hakan-guray',
    ...
    socials: { spotify: 'https://open.spotify.com/artist/2B2mBRXPcC5ONhdhOrJ0zX' },
  },
  {
    name: 'Teymullah',
    slug: 'teymullah',
    ...
    socials: { spotify: 'https://open.spotify.com/artist/4bsb7ElO0Euy32G1OyZ4RE' },
  },
  {
    name: 'Fatma Polat',
    slug: 'fatma-polat',
    ...
    socials: { spotify: 'https://open.spotify.com/artist/7J15rRmjDXGyv3ip6CdmeM' },
  },
  {
    name: 'zenaly',
    slug: 'zenaly',
    ...
    socials: { spotify: 'https://open.spotify.com/artist/4t8Vci0kIxjhdnS9FlSjDd' },
  },
  {
    name: 'Atilla Kaya',
    slug: 'atilla-kaya',
    ...
    socials: { spotify: 'https://open.spotify.com/artist/55dxJQtMgnMst1oFt98djw' },
  },
]
...
async function main() {
  ...
  console.log('Artist seed completed')
}
